...
function renderDocsHtml(markdown, repo, tag2, images) {
  const rawBase = `https://raw.githubusercontent.com/${repo}/${tag2}/`;
  const blobBase = `https://github.com/${repo}/blob/${tag2}/`;
...
function SettingsView({ catalog, onSaved }) {
  ...
  const addSource = () => {
    ...
    if (!value) return;
    const source = newKind === "org" ? { kind: "org", org: value, topic: newTopic.trim() || "oie-plugin" } : { kind: "repo", repo: value };
    setSettings({ ...settings, customSources: [...settings.customSources, source] });
    setNewValue("");
  };
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3", style: { maxWidth: 760 } }, /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement("div", { className: "panel-header" }, "Sources"), /* @__PURE__ */ React.createElement("div", { className: "panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "hint mb-2" }, "Bundled sources ship with the store and update with store releases. Custom sources are additive and stored on this engine."), /* @__PURE__ */ React.createElement("table", { className: "dt" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Source"), /* @__PURE__ */ React.createElement("th", null, "Origin"), /* @__PURE__ */ React.createElement("th", null))), /* @__PURE__ */ React.createElement("tbody", null, settings.bundledSources.map((s, i) => /* @__PURE__ */ React.createElement("tr", { key: `b${i}` }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, s.kind === "org" ? `org: ${s.org} (topic: ${s.topic})` : `repo: ${s.repo}`), /* @__PURE__ */ React.createElement("td", { className: "text-text-dim" }, "bundled"), /* @__PURE__ */ React.createElement("td", null))), settings.customSources.map((s, i) => /* @__PURE__ */ React.createElement("tr", { key: `c${i}` }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, s.kind === "org" ? `org: ${s.org} (topic: ${s.topic})` : `repo: ${s.repo}`), /* @__PURE__ */ React.createElement("td", { className: "text-text-dim" }, "custom"), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: () => setSettings({ ...settings, customSources: settings.customSources.filter((_, j) => j !== i) }) }, "Remove")))))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 items-center mt-3" }, /* @__PURE__ */ React.createElement("select", { className: "field", style: { maxWidth: 110 }, value: newKind, onChange: (e) => setNewKind(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "repo" }, "repo"), /* @__PURE__ */ React.createElement("option", { value: "org" }, "org")), /* @__PURE__ */ React.createElement(
    "input",
    {
      className: "field",
      style: { maxWidth: 260 },
